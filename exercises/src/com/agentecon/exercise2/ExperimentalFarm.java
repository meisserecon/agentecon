...
public class ExperimentalFarm extends Firm implements IProducer {
	...
	private CovarianceBasedStrategy strategy;

	public ExperimentalFarm(IAgentIdGenerator id, IShareholder owner, IStock money, IStock land, IProductionFunction prodFun, IMarketStatistics stats) {
		...
		this.strategy = new CovarianceBasedStrategy(getFinancials());
	...
	public void offer(IPriceMakerMarket market) {
		double budget = strategy.calcCogs(getMoney().getAmount(), 0.0);
