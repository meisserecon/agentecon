...
public class AgentLoader extends ClassLoader {
	...
	private static final String JAR_PATH = "jar/simulation.jar";
	...
	public AgentLoader(String owner, String repo, String branch) throws SocketTimeoutException, IOException{
		this(new URL("https://api.github.com/repos/" + owner + "/" + repo + "/contents/" + JAR_PATH + "?ref=" + branch).openStream());
	}

	public AgentLoader(Path jarFile) throws IOException {
		this(Files.readAllBytes(jarFile));
	}
	
	public AgentLoader(InputStream input) throws SocketTimeoutException, IOException{
		this(readData(input));
	}
	...
	public AgentLoader(byte[] jarData) {
	...
	public IAgentFactory load() throws IOException {
		try {
	...
	public static void main(String[] args) throws SocketTimeoutException, IOException {
		IAgentFactory fac = new AgentLoader().load();
